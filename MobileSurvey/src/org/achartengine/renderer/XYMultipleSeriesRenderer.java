...
public class XYMultipleSeriesRenderer extends DefaultRenderer {
	...
	public void initAxesRangeForScale(int i) {
		...
		double[] range = new double[] { mMinX[i], mMaxX[i], mMinY[i],
				mMaxY[i] };
	 ...
	 * want the spacing to be a half of the bar width, set this value to
	 * 0.5.
	 * 
	 * @param spacing
	 ...
	 * 
	 * @param range
	 *                an array having the values in this order: minX, maxX,
	 *                minY, maxY
	 * @param scale
	 *                the renderer scale
	 */
